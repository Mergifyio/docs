...
no hex literals, no Chakra references, no `--color-mergify-blue` references, and components must
use semantic tokens (not primitives) so dark mode works automatically.
