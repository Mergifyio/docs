...
There are two ways to merge the draft PR directly:
...
`batch_size` to be greater than 1. Mergify creates the draft PR as usual, runs
CI on it, and then merges the draft PR into the base branch using the GitHub
