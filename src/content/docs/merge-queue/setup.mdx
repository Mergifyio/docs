...
| Goal | Feature | Guide |
|------|---------|-------|
| Skip manual queueing | Auto-queue approved PRs | [Auto-Merge](/merge-protections/auto-merge) |
| Merge faster | Test multiple PRs in parallel | [Parallel checks](/merge-queue/performance#parallel-checks) |
