...
touch. This is optional and independent of merge queue batching. To wire it up, follow the Job
Selection section of the [GitHub Actions integration](/integrations/gha#job-selection). It walks
through:
...
[Buildkite integration](/integrations/buildkite#job-selection) walks through the first two steps for
...
the [GitHub Actions integration](/integrations/gha#job-selection), with `merge-queue` added to its
`outputs`:
