...
Actions](/integrations/gha#monorepo-ci) and [Buildkite](/integrations/buildkite#monorepo-ci)
...
integration](/integrations/gha#monorepo-ci) ships a ready-made
...
- [GitHub Actions](/integrations/gha#monorepo-ci) and
  [Buildkite](/integrations/buildkite#monorepo-ci) integrations: reuse the same scopes to skip
