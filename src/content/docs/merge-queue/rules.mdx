---
title: Using Queues Rules
description: Learn how to implement queues rules and route your pull requests.
---

::: caution
    On June 30th, 2025 the implicit priority that queue rules had, based on their order
    in the `queue_rules` section of the Mergify configuration file, will be removed in favor
    of using [priority rules](/merge-queue/priority).
    This will impact you only if you have more than 1 queue rule. If you do, a transformation
    pull request will automatically be created to help you make the required change in your
    configuration.
:::
...
categorizing pull requests based on any criteria you define.
...
step-by-step guide on how to set up multiple queues and some configuration
options that you can use.

1. **Define Your Queue Rules**: Start by identifying the different queues you
   need. This could be based on your project's requirements, the type of pull
