...
directly. The resulting merge commit is titled after the pull requests included
in the batch (for example, `Merged #42, #43, #44`), with `Merged by Mergify
Merge Queue` as its body.

<GitGraph
  nodes={[
    { id: "A", label: "A", role: "external" },
    { id: "B", label: "B", role: "external" },
    { id: "D1", label: "D1", role: "queued" },
    { id: "D2", label: "D2", role: "queued" },
    { id: "M", label: "M", role: "merged" },
  ]}
  edges={[
    { from: "A", to: "B" },
