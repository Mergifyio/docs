...
This could be due to various reasons. Your `max_parallel_checks` number might
...
Remember, the primary goal of parallel checks is to reduce the overall time to
merge all PRs. It does not necessarily decrease the time to merge a single PR.
