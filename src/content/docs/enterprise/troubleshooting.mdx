...
A check that fails on certificate verification means the server presents a certificate Mergify does
not trust. See [Trusting a Private CA](/enterprise/custom-ca).
