...
Mergify offers flexible pricing with three tiers to match your CI/CD automation
needs.

:::note
  We had previously offered other plans, however, these are our only available
  now. If you want to migrate to another plan, see [Switching or Cancelling
  Plans](#switching-or-cancelling-plans).
:::

### Free Plan (Limited Features)

Ideal for teams getting started with CI/CD automation. This plan includes:
- Workflow Automation: Automate merges, labels, and rebases.
- Merge Protection: Enforce rules and freeze policies.
- Merge Queue: Public repositories, parallel checks, queue rules.
- CI Insights: Basic job and test analytics, 24 hours data retention.

👉 No cost, [get started instantly](https://dashboard.mergify.com)!

### Paid Plan (Advanced Features, Per-Seat Pricing)

Our Paid Plan offers flexibility by allowing you to subscribe to individual
products based on your needs. Instead of a bundled package, you can choose
specific features that enhance your CI/CD workflows:

- Workflow Automation: Private repository support.

- Merge Protection: Scheduled merges & freeze management.

- Merge Queue: Smart prioritization, parallel checks, analytics, API access.

- CI Insights: 30-day data retention, flaky test detection, complete test
  analytics, quarantine.

Each product is billed separately, giving you full control over your
subscription. You only pay for what you use, ensuring a cost-effective solution
tailored to your CI/CD requirements.

### Enterprise Plan (On-Premise & GHES Support)

For organizations requiring on-premise deployment and dedicated support.
Includes:
...
[Schedule a call](http://calendly.com/mergify/demo) to discuss Enterprise
solutions.
