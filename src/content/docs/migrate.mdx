...
<DocsetGrid>
	<Docset title="Bulldozer" path="/migrate/bulldozer" icon="lucide:truck">
		Move from Bulldozer's automerge to Mergify rules and Merge Queue.
	</Docset>
	<Docset title="Bors‑NG" path="/migrate/bors-ng" icon="lucide:bot">
...
Don't see your tool? [Tell us](mailto:support@mergify.com) which one to add next.
