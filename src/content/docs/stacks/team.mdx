...
[Automatically delete head branches](/stacks/setup#3-configure-github), which
lets GitHub retarget each PR onto `main` as the one below it merges.
Someone with admin rights turns it on once.
