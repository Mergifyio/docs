...
|---|---|---|
| Create a stack | `mergify stack new <name>` + commits | `gt create [name]` per branch |
...
| Alternate base branch | `mergify stack new <name> --base <remote>/<branch>` | Multi-trunk support |
...
- **Rules engine**: 70+
  [pull request attributes](/configuration/conditions#attributes-list),
  18 [actions](/workflow/actions), cascading logic for
