...
| `test: add registration tests` | `stack/alice/feat/auth/add-registration-tests--g7h8i9j0` |
...
| C (third) | `.../add-registration-endpoint--d4e5f6a7` | `.../add-registration-tests--g7h8i9j0` |
