...
<DocsetGrid>
  <Docset title="Assign" path="assign">
  ...
  <Docset title="Close" path="close">
    Close a pull request.
  </Docset>
  <Docset title="Copy" path="copy">
    Copy a pull request.
  </Docset>
  <Docset title="Comment" path="comment">
    Comment a pull request.
  </Docset>
  <Docset title="Delete Head Branch" path="delete_head_branch">
    Delete pull request head branch.
  </Docset>
  <Docset title="Dismiss Reviews" path="dismiss_reviews" icon={IoIosRemoveCircleOutline}>
    Dismiss previous reviews on a pull request.
  </Docset>
  <Docset title="Edit" path="edit">
  ...
  <Docset title="Label" path="label">
    Add, remove or toggle label on a pull request.
  </Docset>
  <Docset title="Merge" path="merge">
    Automate the merging of your pull requests.
  </Docset>
  <Docset title="Post Check" path="post_check">
    Create a check-run on a pull request.
  </Docset>
  <Docset title="Rebase" path="rebase">
