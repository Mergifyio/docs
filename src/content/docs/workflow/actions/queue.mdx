...
:::note
  Mergify automatically injects your GitHub branch protection and ruleset
  rules as queue conditions. If some ruleset rules are incompatible with your
  queue setup, see [GitHub Rulesets
