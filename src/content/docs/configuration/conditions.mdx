...
ruleset requires code owner review or last-push approval, Mergify [injects the
matching condition](/merge-queue/github-rulesets) into the rules it evaluates
and shows it in the check summary.
