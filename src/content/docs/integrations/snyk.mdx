...
3. **Mergify Configuration**
   ...
   file](/configuration/file-format) file in the repository root.
     ...
     This configuration uses [`auto_merge`](/merge-protections/auto-merge)
     to automatically merge or queue Snyk PRs when they meet the defined
     merge protection conditions.
