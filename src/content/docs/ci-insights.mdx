...
CI Insights provides monitoring and analysis for your CI pipeline jobs — the
individual tasks that run as part of your pipeline (e.g., build, test, deploy
steps). CI Insights tracks job-level metrics and health status.
