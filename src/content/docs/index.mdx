...
<div id="home">
  ...
  <section id="products" class="home-products">
    ...
    <DocsetGrid>
      ...
      <Docset title="CI Insights" path="/ci-insights" icon="lucide:lightbulb">
      ...
      <Docset title="Merge Protections" path="/merge-protections" icon="lucide:shield-user">
        Advanced guardrails before code lands.
      </Docset>
      <Docset title="Stacks" path="/stacks" icon="lucide:layers">
