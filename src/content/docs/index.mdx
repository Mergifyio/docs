...
import {MdMonitorHeart, MdScheduleSend, MdOutlineLightbulb} from 'react-icons/md';
...
<DocsetGrid>
  <Docset
    title="Using CI Insights"
    path="/ci-insights"
    icon={MdOutlineLightbulb}
  >
    Overview of CI Insights functionalities.
  </Docset>
  <Docset
    title="Configuring Test Frameworks"
    path="/ci-insights/#test-framework-configuration"
    icon={GrTest}
  >
    Configuring tests reports for CI Insights.
  </Docset>
...
<DocsetGrid>
  <Docset
    ...
    icon={FaRegLightbulb}
  >
    Understand what merge queue is and how to use them.
  </Docset>
  <Docset
  ...
  <Docset
    ...
    path="/merge-queue/rules"
    icon={BiSolidCoinStack}
  >
    Learn how to implement merge queue rules and route your pull requests.
  </Docset>
  <Docset
