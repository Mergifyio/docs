...
2. **In-app ticket:** From the Mergify dashboard, open the **Help Center** in
  the sidebar and pick **Contact us**. Choose the **Problem**, **Question**, or
  **Feedback** tab, describe the issue, and attach files. The **Problem** tab
  also takes the URLs of the pull requests concerned. We automatically attach
  account context, which speeds up triage.
