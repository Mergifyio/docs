...
import MitigationScreenshot from "../../images/test-insights/mitigation.png"
...
<Image src={MitigationScreenshot} alt="Mitigation dashboard: quarantine metrics and quarantined-tests list" />
