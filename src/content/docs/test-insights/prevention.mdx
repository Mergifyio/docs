...
import PreventionScreenshot from "../../images/test-insights/prevention.png"
...
<Image src={PreventionScreenshot} alt="Prevention dashboard: caught-flaky metrics and new-tests list" />
