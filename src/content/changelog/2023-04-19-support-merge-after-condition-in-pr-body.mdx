...
tags:
  - Workflow Automation
description: "A new `Merge-After` field is now recognized by Mergify."
---
...
[merge — Mergify  documentation](https://docs.mergify.com/actions/merge/#defining-a-minimum-date-to-merge)
