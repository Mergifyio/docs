...
tags:
  - Merge Queue
description: "The `priority_rules` configuration option has been moved from the `queue_rules` definition to be a top-level option in the Mergify configuration file."
---
