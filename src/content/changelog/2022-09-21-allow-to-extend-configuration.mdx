...
tags:
  - Rules
description: "The Mergify configuration file now supports a new keyword `extends` which allows to inherits from a configuration file from a different repository."
---
