  ...
  },
  {
    ...
    children: [
      ...
      { title: 'Batches', path: '/merge-queue/batches', icon: TbPackages },
      {
        ...
        children: [
          { title: 'Overview', path: '/merge-queue/scopes', icon: FaRegLightbulb },
          {
            title: 'File Patterns',
            path: '/merge-queue/scopes/file-patterns',
            icon: AiOutlineFile,
          },
          { title: 'Nx', path: '/merge-queue/scopes/nx', icon: SiNx },
          { title: 'Bazel', path: '/merge-queue/scopes/bazel', icon: SiBazel },
          { title: 'Turborepo', path: '/merge-queue/scopes/turborepo', icon: SiTurborepo },
          { title: 'Other Build Tools', path: '/merge-queue/scopes/others', icon: BsGear },
        ],
      },
