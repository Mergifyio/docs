		...
		children: [
			...
			{ title: 'Auto-Retry', path: '/ci-insights/auto-retry', icon: FaRotateRight },
			{
				...
				children: [
					...
					{ title: 'Jest', path: '/ci-insights/jest', icon: SiJest },
					{ title: 'Playwright', path: '/ci-insights/playwright', icon: SiJavascript },
					{ title: 'JUnit', path: '/ci-insights/junit', icon: SiJunit5 },
					{ title: 'TestNG', path: '/ci-insights/testng', icon: SiTestinglibrary },
					{ title: 'PHPUnit', path: '/ci-insights/phpunit', icon: SiPhp },
					{ title: 'Pest', path: '/ci-insights/pest', icon: SiPhp },
					{ title: 'Rust', path: '/ci-insights/rust', icon: SiRust },
					{ title: 'MSTest', path: '/ci-insights/mstest', icon: SiDotnet },
					{ title: 'NUnit', path: '/ci-insights/nunit', icon: SiDotnet },
					{ title: 'RSpec', path: '/ci-insights/rspec', icon: SiRuby },
					{ title: 'Minitest', path: '/ci-insights/minitest', icon: SiRuby },
				],
			},
		],
	},
