...
In this configuration, when a pull request has at the label backport it is
backported. Then, when the backport has been created and passes the check named
